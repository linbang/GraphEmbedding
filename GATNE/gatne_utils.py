...
import dgl
import numpy as np
from sklearn.metrics import (auc, f1_score, precision_recall_curve, roc_auc_score, average_precision_score)

def parse_args():
    parser = argparse.ArgumentParser()

    parser.add_argument('--input', type=str, default='../dataset/Amazon/data',
...
def evaluate(model, true_edges, false_edges):
    ...
    return roc_auc_score(y_true, y_scores), f1_score(y_true, y_pred), auc(rs, ps), average_precision_score(y_true, y_scores)
